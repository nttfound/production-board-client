...
/**
 * UpdateBanner — floats at the top-right of the screen.
 * Listens to electron-updater events forwarded via preload.js.
 */
export default function UpdateBanner() {
  ...
  const accentLine = (color) => ({
    height: 2,
    background: `linear-gradient(90deg, ${color}cc, ${color}33, transparent)`,
  });
    ...
    <div style={container}>
      ...
      <div style={{ padding: '16px 18px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          <div style={{ width: 30, height: 30, borderRadius: 8, background: 'rgba(37,99,235,0.12)', border: '1px solid rgba(37,99,235,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" style={{ animation: 'spin 1.5s linear infinite' }}>
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
              <polyline points="7 10 12 15 17 10"/>
              <line x1="12" y1="15" x2="12" y2="3"/>
            </svg>
    ...
    <div style={container}>
      ...
      <div style={{ padding: '16px 18px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <button onClick={handleDismiss} style={{ background: 'none', border: 'none', color: '#333', cursor: 'pointer', padding: 4 }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
              <line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>
            </svg>
          </button>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button style={{ ...btnPrimary, background: 'linear-gradient(135deg, #16a34a, #15803d)', border: '1px solid rgba(22,163,74,0.35)', boxShadow: '0 2px 8px rgba(22,163,74,0.3)' }} onClick={handleInstall}
