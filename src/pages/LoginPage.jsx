    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text-disabled)', fontSize: 9, fontFamily: 'var(--font-text)', letterSpacing: '0.2em', textTransform: 'uppercase', marginTop: 6 }}>
        ...
        >
          <div style={{ display: 'grid', gap: 14 }}>
            <div>
              <label style={{
                ...
                color: 'var(--text-faint)', fontFamily: 'var(--font-text)',
          ...
          {error && (
            <div style={{
              ...
              color: 'var(--status-red)', fontSize: 11, fontFamily: 'var(--font-text)',
            }}>
              {error}
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13, fontWeight: 700, fontFamily: 'var(--font-text)',
